  ...
  <body style="background:#003A1E">
	...
	<div class="container-fluid" style="margin-top: 30px">
      ...
      <div class="row-fluid">
		...
		<div class="well loginBox" style="width: 400px; margin: 20px auto; border: solid 1px #d9d9d9; padding: 30px 20px; border-radius: 8px">
		<div style="margin: 0 auto">
			<div class="well-sm">
				...
				<h3 style="margin: 5px 0 0.4em 0; font-size: 16px; color: #fff; font-weight: bold"><?php echo $q_instansi->nama; ?></h3>
				<div style="color: #fff; font-size: 13px" class="clearfix">Sistem Informasi Manajemen Tugas</div>
			 </div>
		</div>
