...
if ($mode == "edt" || $mode == "act_edt") {
	...
	$diteruskan_ke		= explode("<br/>",$datpil->diteruskan_ke);
...
<div class="navbar navbar-inverse">
	...
	<div class="col-lg-6">	
		...
		<tr><td width="20%">Diteruskan ke </td><td>
			 <select name="diteruskan_ke[]" style="width:200px" multiple>
				
				
				<?php
				$select_diteruskan = array ('Panmud Hukum','Kasubag Umum','Sekretaris','Wakil Ketua','Ketua');
				foreach ($select_diteruskan as $row)
					echo "<option ".( in_array($row,$diteruskan_ke) ? "selected='selected'": "")." value='$row'>$row</option>";				
				?>
